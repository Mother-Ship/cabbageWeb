...
public class TipConsts {
    ...
    public static final String FORMAT_ERROR = "%s不是合法的%s。我们不再支持文中掺杂命令。";
    public static final String ARGUMENTS_LESS_THAN_PARAMETERS = "提供的实参数量%d 小于该命令必须的形参数量%d。";
    public static final String ARGUMENTS_MORE_THAN_PARAMETERS = "提供的实参数量%d小于该命令允许的最大形参数量（包含可选形参和必需形参）%d。";
    ...
    public static final String NO_RECENT_RECORD = "玩家%s最近没有游戏记录。";
    public static final String NO_RECENT_RECORD_PASSED = "玩家%s最近没有Pass的游戏记录。";
